---
title: "Lung healthy cell-type-enriched modules results"
...
```{r}
ll = list.files("/Users/kushaldey/Documents/singlecellLDSC/data/Gene_Scores/Modules/healthy/celltype_enriched/pancreas/", full.names = T)
ll
```
...
names(size_vec) = list.files("/Users/kushaldey/Documents/singlecellLDSC/data/Gene_Scores/Modules/healthy/celltype_enriched/pancreas/")
size_vec
total_genes = nrow(df)
total_genes
```
...
```{r}
LDSC_proc_results = get(load("/Users/kushaldey/Documents/singlecellLDSC/output/healthy_celltype_enriched_lung_output_Mar4_2020_v2.1.rda"))
