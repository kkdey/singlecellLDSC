...
```{r}
ll = list.files("/Users/kushaldey/Documents/singlecellLDSC/data/Gene_Scores/Modules/healthy/celltype_enriched/blood/", full.names = T)
ll
```
...
names(size_vec) = list.files("/Users/kushaldey/Documents/singlecellLDSC/data/Gene_Scores/Modules/healthy/celltype_enriched/blood/")
size_vec
total_genes = nrow(df)
total_genes
```
